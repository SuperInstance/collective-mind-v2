...
<head>
    ...
    <title>collective-mind-v2</title>
...
<body>
    <div class="container">
        <div class="hero">
            <h1>collective-mind-v2</h1>
            <p class="subtitle">Fleet-wide knowledge graph and collective intelligence</p>
        </div>
        ...
        <div class="endpoints">
            ...
            <div class="endpoint">POST /api/knowledge → add knowledge</div><div class="endpoint">GET /api/query → query knowledge graph</div><div class="endpoint">GET /api/insights → generate collective insights</div>
        </div>
